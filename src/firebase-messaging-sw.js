...
messaging.onBackgroundMessage((payload) => {
  ...
  const opsi = {
    ...
    icon: '/absenyuk-192.png'
  };
  self.registration.showNotification(judul, opsi);
});

// Handler fetch minimal (pass-through, tanpa caching/offline mode).
// Beberapa browser mensyaratkan service worker punya listener 'fetch'
// supaya situs dianggap PWA yang benar-benar instalable, bukan cuma
// shortcut biasa - walau di sini kita belum implementasi mode offline.
